...
public class DemoHttpHandler_noloader extends AsyncHttpResponseHandler {
    ...
    public DemoHttpHandler_noloader(Context context, HttpResponses httpResponses, String message, int identifier) {
